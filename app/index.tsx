...
import RawCapturePanel from "@/components/RawCapturePanel";
...
export const RAW_NOTIFY_CHAR_UUID = "12345678-1234-1234-1234-1234567890ae";
...
export default function HomeScreen() {
  ...
  const renderScene = ({ route }: { route: { key: string } }) => {
    switch (route.key) {
      ...
      case "rf":
        return <RfPanel isOpen={index === 1} sendDataToDevice={sendDataToDevice} />;
      case "ir":
        return <IrMenu />;
      case "rfrx":
        return (
      ...
      case "raw":
        return (
          <RawCapturePanel
            device={connectedDevice}
            isOpen={index === 3}
            rawCharacteristicUUID={RAW_NOTIFY_CHAR_UUID}
            sendDataToDevice={sendDataToDevice}
            serviceUUID={SERVICE_UUID}
          />
        );
